...
//
// Simple text image content element
$GLOBALS['TCA']['tt_content']['columns']['CType']['config']['items'][] = [
    'Text & Image',
    'themebootstrap4_text_image',
    'new-content-el-text-image',
];
...
//
// Simple icon content element
$GLOBALS['TCA']['tt_content']['columns']['CType']['config']['items'][] = [
    'Icon',
    'themebootstrap4_icon',
    'new-content-el-icon',
];
...
//
// Simple image content element
$GLOBALS['TCA']['tt_content']['columns']['CType']['config']['items'][] = [
    'Image',
    'themebootstrap4_image',
    'new-content-el-image',
];
